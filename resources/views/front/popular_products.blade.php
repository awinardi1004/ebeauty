...
<x-search-nav/>
 ...
 <section class="bg-gray-200 p-4 mt-8">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-3xl font-semibold text-black">Best Seller</h2>
        </div>
            ...
            @endphp
                ...
                <div class="relative group bg-red-300 rounded-md p-2 flex flex-col items-center">
                    <div class="w-full aspect-square overflow-hidden rounded-md mb-2">
                        <img src="{{ asset('storage/' . $popular_product->productImages->first()->image_path) }}" alt="Foto Produk" class="w-full h-full object-cover" />
                    </div>
